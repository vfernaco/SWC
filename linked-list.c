...
static int compEQ(TYPE_LIST_KEY primary_key1, TYPE_LIST_KEY primary_key2)
{
  int rc = 0;

  if (strcmp(primary_key1, primary_key2) == 0)
    rc = 1;
...
ListData *findList(List *l, TYPE_LIST_KEY primary_key)
{
  ListItem *current;
